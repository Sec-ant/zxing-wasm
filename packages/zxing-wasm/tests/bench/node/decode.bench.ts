...
const samples: FormatSample[] = [
  {
    format: "QRCode",
    path: "../../vendor/zxing-cpp/test/samples/qrcode-1/1.webp",
  },
  {
    format: "DataMatrix",
    path: "../../vendor/zxing-cpp/test/samples/datamatrix-2/01.webp",
  },
  {
    format: "Aztec",
    path: "../../vendor/zxing-cpp/test/samples/aztec-1/abc-19x19C.png",
  },
  {
    format: "PDF417",
    path: "../../vendor/zxing-cpp/test/samples/pdf417-1/01.png",
  },
  {
    format: "MicroPDF417",
    path: "../../vendor/zxing-cpp/test/samples/micropdf417-1/MPDF-0.png",
  },
  {
    format: "Code128",
    path: "../../vendor/zxing-cpp/test/samples/code128-1/1.png",
  },
  {
    format: "Telepen",
    path: "../../vendor/zxing-cpp/test/samples/telepen-1/telepen-alpha-2.png",
  },
  {
    format: "EAN-13",
    path: "../../vendor/zxing-cpp/test/samples/ean13-1/4.webp",
  },
];
