 ...
 *
 * @remarks
 * The function creates a new object that spreads all properties from the input,
 * but converts the image data from a Uint8Array to a PNG Blob when available.
 * If no image data is present, the image property will be null.
 */
