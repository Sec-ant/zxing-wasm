var ZXing = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    var wasmBinaryFile;
    if (Module["locateFile"]) {
      wasmBinaryFile = "zxing_writer.wasm";
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      wasmBinaryFile = new URL("zxing_writer.wasm", import.meta.url).href;
    }
    ...
    var _free = (Module["_free"] = (a0) =>
      (_free = Module["_free"] = wasmExports["V"])(a0));
    ...
    var _setThrew = (a0, a1) => (_setThrew = wasmExports["Z"])(a0, a1);
    var setTempRet0 = (a0) => (setTempRet0 = wasmExports["_"])(a0);
